# Raw Meeting Notes — Q1 Ops Review (Module 3 Exercise 2)

**Meeting:** Q1 Ops Review
**Date:** March 10, 2026
**Attendees:** Riley, Drew, Alex, Jordan

---

quarterly ops review. went long, ran ~50 min. Drew had hard stop at 10

ROCKS / PROJECTS
- client onboarding process — Jordan says it's improved but still manual. new checklist is done but hasn't been shared with team. need to actually train on it. Alex offered to run a 20 min walkthrough. when?? didn't decide
...
- decided NOT to renew contract with old vendor (Apex Tools). alex to send the non-renewal notice. does need to go out before march 15 or auto-renews
- going to do quarterly in-person in may. Denver probably. riley to research venues and send options to Drew by march 20

DISCUSSED BUT NOT DECIDED
- should we start doing client NPS instead of satisfaction surveys? Drew raised it. no decision, revisit next quarter
- someone mentioned the onboarding deck might be outdated. Alex thinks it still has old branding. needs to be checked but nobody took it
