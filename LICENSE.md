...
- **Attribution** — You must give appropriate credit to Till CFO, provide a link to the license, and indicate if changes were made.
- **NonCommercial** — You may not use the material for commercial purposes (e.g., reselling the course or charging for access to it). Using what you *learn* — including skills you build for your own organization — is of course yours.
